...
for i in range(loop_count):
    ...
    clf = RandomForestClassifier(n_estimators=num_predict_data, max_depth=1000)
...
with open(f'scripts/evaluation_feature_importance/result/{project}_result.txt', 'w') as f:
