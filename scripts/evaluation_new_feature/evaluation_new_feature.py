...
# feature_4
#train_data = df_train[["branch_hotness","commits_on_files_touched", "pr_branch_active", "pr_file_active"]]
# feature_5
train_data = df_train[["lines_modified_open", "branch_hotness","commits_on_files_touched", "pr_branch_active", "pr_file_active"]]
# feature_7
#train_data = df_train[["num_commits_open","files_modified_open","lines_modified_open", "branch_hotness","commits_on_files_touched", "pr_branch_active", "pr_file_active"]]
...
#predict_data = df_predict[["branch_hotness","commits_on_files_touched", "pr_branch_active", "pr_file_active"]]
predict_data = df_predict[["lines_modified_open", "branch_hotness","commits_on_files_touched", "pr_branch_active", "pr_file_active"]]

#predict_data = df_predict[["num_commits_open","files_modified_open","lines_modified_open", "branch_hotness","commits_on_files_touched", "pr_branch_active", "pr_file_active"]]
...
for i in range(loop_count):
    ...
    with open(f'scripts/evaluation_new_feature/result_5f/{project}_result_f_new.txt', 'w') as f:
    ...
    for index, row in df.iterrows():
        ...
        if i == 0:
            ...
            #train_data2 = row[["lines_modified_open", "branch_hotness","commits_on_files_touched", "pr_branch_active", "pr_file_active"]]
            train_data2 = row[["num_commits_open","files_modified_open","lines_modified_open", "branch_hotness","commits_on_files_touched", "pr_branch_active", "pr_file_active"]]
        ...
        predict_data2 = row[["lines_modified_open", "branch_hotness","commits_on_files_touched", "pr_branch_active", "pr_file_active"]]
        #predict_data2 = row[["num_commits_open","files_modified_open","lines_modified_open", "branch_hotness","commits_on_files_touched", "pr_branch_active", "pr_file_active"]]
        ...
        first_look = df_first_look[["lines_modified_open", "branch_hotness","commits_on_files_touched", "pr_branch_active", "pr_file_active"]]
        #first_look = df_first_look[["num_commits_open","files_modified_open","lines_modified_open", "branch_hotness","commits_on_files_touched", "pr_branch_active", "pr_file_active"]]
    ...
    with open(f'scripts/evaluation_new_feature/result_5f/{project}_result_f_new.txt', 'a') as f:
...
joblib.dump(predict_data, f'scripts/evaluation_new_feature/result_5f/pull_request_feature_{project}.pkl')
joblib.dump(df, f'scripts/evaluation_new_feature/result_5f/pull_request_feature_series_{project}.pkl')
