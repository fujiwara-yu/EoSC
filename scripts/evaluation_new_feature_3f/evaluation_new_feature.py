...
train_data = df_train[["lines_modified_open", "pr_branch_active", "pr_file_active"]]
...
predict_data = df_predict[["lines_modified_open","pr_branch_active", "pr_file_active"]]
...
with open(f'scripts/evaluation_new_feature_3f/result/{project}_result_f_new.txt', 'w') as f:
...
for i in range(loop_count):
    ...
    for index, row in df.iterrows():
        ...
        if i == 0:
            ...
            train_data2 = row[["lines_modified_open", "pr_branch_active", "pr_file_active"]]
        ...
        predict_data2 = row[["lines_modified_open","pr_branch_active", "pr_file_active"]]
        ...
        first_look = df_first_look[["lines_modified_open", "pr_branch_active", "pr_file_active"]]
    ...
    with open(f'scripts/evaluation_new_feature_3f/result/{project}_result_f_new.txt', 'a') as f:
...
joblib.dump(predict_data, f'scripts/evaluation_new_feature_3f/result/pull_request_feature_{project}.pkl')
joblib.dump(df, f'scripts/evaluation_new_feature_3f/result/pull_request_feature_series_{project}.pkl')
