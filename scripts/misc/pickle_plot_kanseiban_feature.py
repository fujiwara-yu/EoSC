...
a = joblib.load(f"scripts/result/{project}_3.pkl")
b = joblib.load(f"scripts/result/{project}.pkl")
print(a)
print(b)
not_use_datetime = a["hyouka_1"]
use_datetime = b["hyouka_1"]
...
plt.plot(date_n, ans_n, marker="o", label="feature_5")
plt.plot(date_u, ans_u, marker="x", linestyle="dashed", label="feature_3")
